...
/* WIN32_LEAN_AND_MEAN early so any windows.h pulled by reshade.hpp /
 * imgui / etc. doesn't transitively include winsock.h, which would
 * conflict with the winsock2.h that bridge.cpp pulls when both TUs
 * are compiled into the same DLL. */
