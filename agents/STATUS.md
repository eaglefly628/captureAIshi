...
| 小虚 (UE5 Fullstack) | ~45% | 2026-05-15 | v0.3.2 P0 调研 + 架构落 2 doc: `apps/adore_robot/docs/ue58_engine_notes_xiaoxu.md` (11 节引擎侧) + `batch_scene_gen_architecture.md` (Web UI/Flask 5001 + 子进程协议 + Claude SDK NL→PCG)。Robotics Plugin 红字: 5.8 preview 无 Epic 官方源 -> Plan A/B/C 待老白选 (倾向 C)。给小幻挂 P1 (公开参数表 + few-shot + asset 索引 + thumbnail viewpoint)。本期未写生产代码。|
