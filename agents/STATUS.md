...
| 小萱 (Rendering) | ~65% | 2026-05-12 | 03ce4a8: P0 trajectory RDC capture chain fixed (isinstance dispatch + g.trigger_capture()). P2 depth_curve reviewed OK. Push blocked by proxy 403, commit local. |
