...
| 小虚 (UE5 Fullstack) | new | 2026-05-15 | 新岗位，UE5 引擎全栈（C++/编辑器/MRQ/cook/Robotics Plugin）。域 `apps/adore_robot/Source/` + `Plugins/` + `Config/`。首批 P0 待派（.uproject scaffold / MRQ preset）。知识库 `.claude/agents/xiaoxu.md` + `agents/unreal/refs/`。|
