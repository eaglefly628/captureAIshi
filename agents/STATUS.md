...
| 小萱 (Rendering) | ~45% | 2026-04-24 | 1259faa: batman_ak depth_per_frame=true (per-RDC export, no batch-ref contamination indoor/outdoor). RGB heuristic gamma: mean<50 → apply sRGB (UE5 Float SceneColor without C++ rebuild). UE5 depth consistent (batch ref working). |
