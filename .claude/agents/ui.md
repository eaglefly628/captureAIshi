...
- Live preview of RGB + depth + normal captures
...
- `web_ui.py` -- Flask backend, all API routes
...
- Read `agents/rendering/SHARED.md` and `agents/reversing/SHARED.md` for cross-domain context
