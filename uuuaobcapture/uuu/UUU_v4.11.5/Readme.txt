...
==============
v4.11.5:
    - Fixed: The DOF wasn't properly disabled in cutscenes for Final Fantasy VII Rebirth in the latest patch 
...
v4.11.4:
    ...
    - Fixed: Updated for Final Fantasy VII Remake patch released on November 4th 

v4.11.3:
    - Fixed: Adjustments to make the UUU work with Lost Soul Aside and Unknown 9 
